...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a class="btn btn-primary" href="{{route('category.show',$p->id)}}">VER</a>
                <a class="btn btn-primary" href="{{route('category.edit',$p->id)}}">Actualizar</a>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <script>
      window.onload = function(){
            ...
            var modal = $(this)
            modal.find('.modal-title').text('Borrando el category: ' + id)
